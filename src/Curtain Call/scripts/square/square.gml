/// @description  square(x,y,obj,perline,angle,speed)
/// @param x
/// @param y
/// @param obj
/// @param perline
...
/// @param scale
/// @param blend
function square(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {

	var perline = round(argument3) - 1;
	if(perline < 1) exit; // prevent division by 0

	var p1x = argument0 + lengthdir_x(1, (argument4 + 45));
	var p1y = argument1 + lengthdir_y(1, (argument4 + 45));
	var p2x = argument0 + lengthdir_x(1, (argument4 + 135));
	var p2y = argument1 + lengthdir_y(1, (argument4 + 135));
	var p3x = argument0 + lengthdir_x(1, (argument4 + 225));
	var p3y = argument1 + lengthdir_y(1, (argument4 + 225));
	var p4x = argument0 + lengthdir_x(1, (argument4 + 315));
	var p4y = argument1 + lengthdir_y(1, (argument4 + 315));
	...
	repeat(perline) {
		...
		a.image_yscale = argument6;
		a = instance_create(argument0, argument1, argument2);
	    a.direction = point_direction(argument0, argument1, EaseLinear(dist_ratio, p3x, p4x, 1), EaseLinear(dist_ratio, p3y, p4y, 1));
	    a.speed = argument5 * point_distance(argument0, argument1, EaseLinear(dist_ratio, p3x, p4x, 1), EaseLinear(dist_ratio, p3y, p4y, 1));
	    a.image_blend = argument7;
		a.image_xscale = argument6;
		a.image_yscale = argument6;
		a = instance_create(argument0, argument1, argument2);
