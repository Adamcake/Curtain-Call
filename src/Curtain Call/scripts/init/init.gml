...
function init() {
	...
	global.adTrick = false; // Determines if you can use the A<>D trick
	...
	global.timeTicking = false; // Determines if time should be incrementing
	...
	global.windowCap = "I Wanna Be The Curtain Call | Deaths: %D | Time: %H:%M:%S"; // Parsed in update_title automagically
	...
	global.startRoom = rLobby; // The first room when a new game is started
	...
	// 0 = start, 1 = second attack, 2 = super hexagon, 3 = chorus, 4 = chorus mid, 5 = small area, 6 = doruppi, 7 = red blue, 8 = last chorus, 9 = post chorus 2
	global.dbgStartPoint = 0;
}
