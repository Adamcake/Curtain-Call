/// @description: P5 burst + BR spawner creation
instance_create(__view_get(e__VW.XView, 0) + __view_get(e__VW.WView, 0), __view_get(e__VW.YView, 0) + __view_get(e__VW.HView, 0), part5BRSpawner);
